    ...
    <>
      <section className="about" id="about">
        ...
        <div className="about-content">
          ...
          <p rel="noreferrer" className="btn" onClick={() => toggleText("about")}>
            {showFullText.about ? "Read Less" : "Read More"} </p>
        </div>
      </section>
      ...
      <section className="services" id="services">
        ...
        <div className="services-container">
          ...
          <p className="btn" onClick={() => toggleText("service1")}>
          ...
          <div className="services-box">
            ...
            <p  className="btn" rel="noreferrer" onClick={() => toggleText("service2")}>
